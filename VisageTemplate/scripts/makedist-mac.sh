...
NOTARIZE_BUNDLE_ID=com.AcmeInc.VisageTemplate
NOTARIZE_BUNDLE_ID_DEMO=com.AcmeInc.VisageTemplate.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/VisageTemplate.iss
#  git checkout installer/VisageTemplate.pkgproj
