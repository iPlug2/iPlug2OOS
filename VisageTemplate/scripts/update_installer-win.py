...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=VisageTemplate Demo Installer\n"
      else:
        line="OutputBaseFilename=VisageTemplate Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the VisageTemplate Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the VisageTemplate installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=VisageTemplate Demo installer\n"
     else:
       line="SetupWindowTitle=VisageTemplate installer\n"
