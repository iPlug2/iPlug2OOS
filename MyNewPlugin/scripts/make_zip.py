...
def  main():
  ...
  installer = "\installer\MyNewPlugin Installer.exe"
   
  if demo:
    installer = "\installer\MyNewPlugin Demo Installer.exe"
  ...
  ZIPNAME = "MyNewPlugin-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "MyNewPlugin-v" + FULLVERSIONSTR + "-win-demo.zip"
